...
_RN101 = dict(
    ...
    yfcc15m=_pcfg(
        'https://github.com/mlfoundations/open_clip/releases/'
        'download/v0.2-weights/rn101-quickgelu-yfcc15m-3e04b30e.pt'),
)
...
_VITB32 = dict(
    ...
    laion400m_e31=_pcfg(
        'https://github.com/mlfoundations/open_clip/releases/'
        'download/v0.2-weights/vit_b_32-quickgelu-laion400m_e31-d867053b.pt'),
    laion400m_e32=_pcfg(
        'https://github.com/mlfoundations/open_clip/releases/'
        'download/v0.2-weights/vit_b_32-quickgelu-laion400m_e32-46683a32.pt'),
    laion2b_e16=_pcfg(
        'https://github.com/mlfoundations/open_clip/releases/'
        'download/v0.2-weights/vit_b_32-laion2b_e16-af8dbd0c.pth'),
...
_VITB16 = dict(
    ...
    laion400m_e31=_pcfg(
        'https://github.com/mlfoundations/open_clip/releases/'
        'download/v0.2-weights/vit_b_16-laion400m_e31-00efa78f.pt'),
    laion400m_e32=_pcfg(
...
_VITB16_PLUS_240 = dict(
    laion400m_e31=_pcfg(
        'https://github.com/mlfoundations/open_clip/releases/'
        'download/v0.2-weights/vit_b_16_plus_240-laion400m_e31-8fb26589.pt'),
    laion400m_e32=_pcfg(
        'https://github.com/mlfoundations/open_clip/releases/'
        'download/v0.2-weights/vit_b_16_plus_240-laion400m_e32-699c4b84.pt'),
)
